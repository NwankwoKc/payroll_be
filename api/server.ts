...
dotenv.config()
const app = new App ([new AuthController(),new user(),new department(),new Payslip(),new attendance(),new position(),new salary(),new bulkpayment()],process.env.PORT as unknown as number || 3000).express
export default app;
